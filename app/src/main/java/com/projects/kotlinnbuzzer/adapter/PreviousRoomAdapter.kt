...
class PreviousRoomAdapter(private val context: Context) :
   RecyclerView.Adapter<PreviousRoomAdapter.ViewHolder>() {
   ...
   override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
      val itemView =
         LayoutInflater.from(parent.context).inflate(R.layout.prevroom_item, parent, false)
   ...
   override fun onBindViewHolder(holder: ViewHolder, position: Int) {
      ...
      holder.itemView.setOnClickListener {
         ...
         holder.itemView.findNavController()
            .navigate(R.id.action_createRoomFragment_to_roomFragment, bundle)
      }
   }
